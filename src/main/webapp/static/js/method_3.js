...
//    lineChart.setOption(option);
    ...
    timeTicket = setInterval(function () {
        ...
        $.ajax({
            type:"GET",
            url:"/damping/get?name=damping3&pageIndex="+pageIndex,
            contentType:"application/json",
            success:function(data){
                pageIndex = data.pageIndex;
        ...
        $.ajax({
            type:"GET",
            url:"/frequency/get?name=frequency3&pageIndex="+pageIndex,
            contentType:"application/json",
            success:function(data){
                pageIndex = data.pageIndex;
                console.log(JSON.stringify(data));
        ...
        $.ajax({
            type:"GET",
            url:"/modeshape/get?name=modeshape3&pageIndex="+pageIndex,
            contentType:"application/json",
            success:function(data){
                pageIndex = data.pageIndex;
                console.log(JSON.stringify(data));
